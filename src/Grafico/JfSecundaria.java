...
public class JfSecundaria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Control De Inasistencias ");
        ...
        jMenuItem2.setText("Ver Estudiantes");
        ...
        jMenuItem3.setText("Nuevo Profesor");
        ...
        jMenuItem4.setText("Ver Profesores");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        //dispose();  new newProfesor().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfSecundaria().setVisible(true);
            }
        });
    }
